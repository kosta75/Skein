...
<section class="content-container">
	<div id="subNavigationContainer">
		...
		<div id="menu2" class="sub-menu ${colorTheme}">
			<div class="menu-username">
				<a  href="${sessionScope.PersonalURI}">${sessionScope.PersonalURI}</a>
			</div>
	...
	<div id="subUserProfileContainer">
		...
		<!--******************************날씨 정보******************************   -->
         <div style="clear: both; width: 96%; height: 350px; background-color: white; border-radius: 10px 10px 10px 10px; margin-top: 30px;">
         	<div id="whatweather">
         		<div id="observinfo" style="width: 100%; height: 200px; clear: both;"></div>
	...
	<div id="container" class="content-wrapper">
		<!--center  -->
		<div id="containerCenter" class="content-center-wrapper">
			<div id="boardListTimelinContainer"></div>
