...
public interface NotificationDao {
	...
	//알림 조회
	public List<FriendshipNotificationCommand> getFriendshipNotificationByFriendEmail(String email, String friendEmail) throws ClassNotFoundException, SQLException;
