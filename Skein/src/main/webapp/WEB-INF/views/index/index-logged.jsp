						...
						<c:forEach var="imgNumber" begin="0" end="9" step="1">
							<div class="detailImg">
								<c:if test="${imgNumber == 0}">
									<img id="detailImg${imgNumber}" src=""
										style="width: 566px; height: 452px; display: block; z-index: -1; border-radius: 6px 0 0 0;">
								</c:if>
								<c:if test="${imgNumber > 0}">
									<img id="detailImg${imgNumber}" src=""
										style="width: 566px; height: 452px; display: none; z-index: -1; border-radius: 6px 0 0 0;">
								</c:if>
			...
			<div style="float: right; width: 40%;">
					...
					<div style="float: left; padding-top: 15px; width: 200px;">
						<div class="modalcontent">
							...
							<div class="modal-user-profile-image" style="float: left;">
								<img
									src="${pageContext.request.contextPath}/resources/user-profile-image/${sessionScope.BASE_MEMBER_INFO.profileImageFileName}" />
				...
				<div class="modalreply">
					<div class="replyModalList">
						<div class="replyList"
							style="width: 95%; margin: auto; border: 1px solid #fff;">
						</div>

					</div>

					<div id="reply"
						style="clear: both; background: #e4e4e4; width: 99%; height: 50px; border: 1px solid; border-color: #e4e4e4;">
						...
						<div class="replyWriteForm"
							...
							<input class="modalreplyWrite" type="text"
				...
				<div id="historyWriteTabs">
					<div id="historyWriteForm">
						...
						<form id="hitstoryForm" method="post"
							...
							<div id="dropzone">
								<span class="placeholder">내용을 입력해 주세요...</span> <span
									class="help-message">* 이미지를 등록하시려면 여기에 끌어다 놓으세요!</span>
								<div id="writeTextarea" contenteditable="true"></div>
							</div>
							<input type='hidden' name="content" id="content" /> <input
								type="hidden" name="email" value="${LoginUser}" />
							<!--이미지  -->
							...
							<!--날짜  -->
							<div id="historyDate">
								발생일자 : <input type="date" name="startDate"><br /> 종료일자
							...
							<div id="historyemoticon">
								<c:forEach var="i" begin="1" end="16" step="1">
									<img class="emoticon" id="emoticon${i}"
										src="${pageContext.request.contextPath}/resources/media/emoticon/emoticon${i}.png">
								</c:forEach>
							</div>
							<!--  -->
							<div class="write-menu-bar">
								<div id="writeicon">
									...
									</select> <input id="hitstoryWriteBtn" type="button" value="게시"
					...
					<div class="group-item-container">
						<div class="group-item-wrapper">
								...
								<ul>
									...
									<li><c:choose>
											<c:when test="${groupItem.groupCount > 1}">
												<div class="icon-box group-share share-btn" title="그룹 공유하기">그룹
													공유하기</div>
											</c:when>
											<c:otherwise>
							...
							<div class="share-info-div"
								style="text-align: center; border-radius: 10px 10px 10px 10px; width: 250px; /* height: 300px; */ display: none; right: -254px; margin-top: 0px; background-color: white; z-index: 1; position: absolute;">
								<input type="hidden" value="${groupItem.groupSeq}"
										id="boardSeq${groupItem.boardSeq}" class="share-input">
								<b>공 유 하 기</b>
								...
								<div style="clear: both;">
									<a id="share-confirm-btn">확인</a>
									<a id="share-cancel-btn">취소</a>
									...
									<c:if test="${groupItem.groupCount > 2}">
										...
										<img id="share-ALL-choice-btn" >전체선택
										<img id="share-ALL-clear-btn" >전체해제
									</c:if>
								</div>
							</div>
