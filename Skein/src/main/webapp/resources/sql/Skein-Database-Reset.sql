...
-----------------------------------------------------------------------------------------------
-- 14.1 Notifications(사용자 알림) 테이블 삭제 및 생성
...
-- 15. Friendship(친구)
-----------------------------------------------------------------------------------------------
-- 15.1 Friendship(친구) 테이블 삭제 및  생성
/* 친구 */
...
-----------------------------------------------------------------------------------------------
-- 16.1 FriendshipNotification(친구알림) 테이블 삭제 및 생성
/* 친구알림 */
...
-----------------------------------------------------------------------------------------------
-- 18.1 ReplyNotification(댓글알림) 테이블 삭제 및 생성
...
-----------------------------------------------------------------------------------------------
-- 19.1 ShareNotification(공유알림) 테이블 삭제 및 생성
...
DROP INDEX PK_ShareNotification;
...
-- 20. ShareBoard(공유)
-----------------------------------------------------------------------------------------------
-- 20.1 ShareBoard(공유) 테이블 삭제 및 생성
...
-----------------------------------------------------------------------------------------------
-- 18.1 ShareNotification(공유알림) 테이블 삭제 및 생성
ALTER TABLE ShareNotification
	DROP
		CONSTRAINT FK_Notifications_TO_ShareNotif
		CASCADE;
