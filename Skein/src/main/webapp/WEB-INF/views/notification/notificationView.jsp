	...
	<div class="notification-content-wrapper" style="height: 600px; width: 760px; background-color: white; border-radius: 8px 8px 8px 8px;">
		...
		<div id="dock">
				<div class="dock-container" style=" left: 503px; width: 400px; ">
					<a class="dock-item" href="${pageContext.request.contextPath}/notification/?alramSeq=1" style="width: 50px; left: 0px;"><span style="display: none;"></span><input type="hidden" value="1"><img data-dataSeq="1" src="${pageContext.request.contextPath}/resources/media/image/dock/all.gif" alt="home"></a> 
					<a class="dock-item" href="${pageContext.request.contextPath}/notification/?alramSeq=2" style="width: 50px; left: 50px;"><span style="display: none;">Notice</span><input type="hidden" value="2"><img data-dataSeq="2" src="${pageContext.request.contextPath}/resources/media/image/dock/notice.gif" alt="contact"></a> 
					<a class="dock-item" href="${pageContext.request.contextPath}/notification/?alramSeq=3" style="width: 50px; left: 100px;"><span style="display: none;">Friend</span><input type="hidden" value="3"><img data-dataSeq="3" src="${pageContext.request.contextPath}/resources/media/image/dock/friend.gif" alt="portfolio"></a> 
					<a class="dock-item" href="${pageContext.request.contextPath}/notification/?alramSeq=4" style="width: 50px; left: 150px;"><span style="display: none;">Board</span><input type="hidden" value="4"><img data-dataSeq="4" src="${pageContext.request.contextPath}/resources/media/image/dock/board.gif" alt="music"></a> 
					<a class="dock-item" href="${pageContext.request.contextPath}/notification/?alramSeq=5" style="width: 50px; left: 200px;"><span style="display: none;">Reply</span><input type="hidden" value="5"><img data-dataSeq="5" src="${pageContext.request.contextPath}/resources/media/image/dock/reply.gif" alt="video"></a> 
