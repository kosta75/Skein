	...
	<div class="group-item-container">
		...
		<div class="group-item-wrapper">
			<div class="group-item-controller-container">
				<ul>
					<li><div class="icon-box group-item-edit"
							data-boardSeq="${groupItem.boardSeq}"
							data-groupCount="${groupItem.groupCount}" title="수정">수정</div></li>
					<li><div class="icon-box group-item-delete"
							data-groupSeq="${groupItem.groupSeq }"
							data-groupCount="${groupItem.groupCount}" title="삭제">삭제</div></li>
					<li><c:choose>
			...
			<div class="share-info-div"
				...
				<input type="hidden" value="${groupItem.groupSeq}"
					id="boardSeq${groupItem.boardSeq}" class="share-input"> <b>공
					유 하 기</b>
			...
			<div class="group-item-reply-write-form-container">
				...
				<input type="hidden" id="boardSeq" name="boardSeq"
					value="${groupItem.boardSeq}" /> <input type="text" id="boardSeq"
					class="replyWrite" name="replyWrite" />
			</div>
